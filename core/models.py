...
class UserProfile(models.Model):
    ...
    chip_number = models.CharField(max_length=20, unique=True, null=True, blank=True, verbose_name='Numer chip')
    auth_code = models.CharField(max_length=128, blank=True, verbose_name='Kod autoryzacyjny (hash)')
    auth_code_set = models.BooleanField(default=False, verbose_name='Kod ustawiony')
